...
function adicionaLinha(){
    ...
    if(atividades.includes(inputNomeAtividade.value)){
        ...
        linha += `<td>${inputNotaAtividade.value >= spanReprrovado ? imgAprovado : imgReprovado }</td>`;
        linha += '</tr>';
...
function atualizaMediaFinal(){
    ...
    document.getElementById('media-final-resultado').innerHTML = mediaFinal >= notaMinima ? spanAprovado :spanReprrovado;
}
